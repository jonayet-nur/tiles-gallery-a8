...
>
  ...
  <div className="hero-content text-neutral-content text-center">
    <div className="max-w-md">
     ...
     <Link href="/alltiles"><button className="bg-[#e31b61ed] text-white px-6 py-4 inline-flex items-center gap-2 hover:bg-white hover:text-black transition-all duration-300  rounded-2xl"><span>Browse Now </span><ArrowRight className='' ></ArrowRight> </button> </Link>
    </div>
  </div>
</div>
    </div>
